(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function s(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=s(o);fetch(o.href,r)}})();const h="favouriteExercises",b="quote",x="quote_time",M=864e5,L=e=>localStorage.setItem(h,JSON.stringify(e)),y=e=>{try{const t=localStorage.getItem(e);return t?JSON.parse(t):[]}catch(t){return console.error("Error parsing JSON:",t.message),[]}},k=e=>{const t=y(h).filter(s=>s._id!==e);L(t)};async function N(){return(await fetch("https://your-energy.b.goit.study/api/quote")).json()}async function O(){const e=localStorage.getItem(b),t=localStorage.getItem(x);if(e&&t&&Date.now()-Number(t)<M)return JSON.parse(e);try{const s=await N();return localStorage.setItem(b,JSON.stringify(s)),localStorage.setItem(x,Date.now().toString()),s}catch(s){return console.error("Error fetching quote:",s),e?JSON.parse(e):{quote:"No quote available",author:""}}}const F=(e,t)=>`
...
`,T=async e=>{const{quote:t,author:s}=await O();e.innerHTML=F(t,s)},g={root:document.querySelector(".scrollbar_custom"),quoteContainer:document.querySelector(".quote")};let n=1;const v=8,B=(e,t)=>{const s=(t-1)*v;return e.slice(s,s+v)},C=(e=[])=>{const t=new Set;return e.filter(s=>!(s!=null&&s._id)||t.has(s._id)?!1:(t.add(s._id),!0))};function A(){g.root.innerHTML=`
  ...
  `;let i=Math.max(1,n-1),o=Math.min(e,n+1);n===1&&(o=Math.min(e,3)),n===e&&(i=Math.max(1,e-2)),i>1&&(t+=s(1),i>2&&(t+='<li class="dots">...</li>'));for(let r=i;r<=o;r++)t+=s(r);return o<e&&(o<e-1&&(t+='<li class="dots">...</li>'),t+=s(e)),t+="</ul>",t}function m(){if(!g.root)return;const e=C(y(h)||[]);if(!e.length){A();return}const t=Math.ceil(e.length/v);n>t&&(n=t);const s=window.innerWidth<1440?B(e,n):e;g.root.innerHTML=P(s)+(window.innerWidth<1440?H(t):"")}var w;(w=g.root)==null||w.addEventListener("click",e=>{const t=e.target.closest('[data-action="delete"]'),s=e.target.closest('[data-action="start"]'),i=e.target.closest(".pagination-btn");if(t&&(k(t.dataset.id),m()),s){const r=(y(h)||[]).find(a=>a._id===s.dataset.id);r&&K(r,!0,!0)}if(i){const o=Number(i.dataset.page);o!==n&&(n=o,m())}});window.addEventListener("resize",()=>{n=1,m()});m();T(g.quoteContainer);async function J(e,{email:t,rate:s,comment:i}){const o=`https://your-energy.b.goit.study/api/exercises/${e}/rating`;s=Number(s);const r=await fetch(o,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,rate:s,review:i})});if(!r.ok){const a=await r.json();throw new Error(a.message||"Rating failed")}return r.json()}const Q=document.getElementById("form-close-btn"),u=document.querySelector(".backdrop"),q=document.querySelector("#user-email"),E=document.getElementById("user-comment"),R=document.querySelector(".form-send-btn"),D=document.querySelector(".rating-wrapper"),$=document.querySelector(".rating-star-value"),j=document.querySelector(".backdrop-form");let _=null;const c={rate:0,email:"",comment:""};R.disabled=!1;function U(){q.value="",E.value="",c.rate=0,c.comment="",c.email="",$.textContent="0.0",document.querySelectorAll(".rating-star-icons").forEach(t=>{t.style.fill="var(--white-20)"})}Q.addEventListener("click",()=>{u.classList.remove("is-open")});u.addEventListener("click",e=>{e.target===u&&u.classList.remove("is-open")});D.addEventListener("click",e=>{const t=document.querySelectorAll(".rating-star-icons");if(e.target.dataset.id){c.rate=Number(e.target.dataset.id);for(let s=0;s<5;s++)t[s].style.fill=s<c.rate?"var(--star-color)":"var(--white-20)";$.textContent=`${c.rate}.0`}});function W(e){_=e,u.classList.add("is-open")}j.addEventListener("submit",Y);async function Y(e){if(e.preventDefault(),c.email=q.value.trim(),c.comment=E.value.trim()||void 0,!c.rate){alert("Please select a rating");return}if(!c.email){alert("Please enter your email");return}try{await J(_,c),alert("Your rating is accepted"),U(),u.classList.remove("is-open")}catch(t){alert(`Error: ${t.message}`)}}const l=document.querySelector(".exr-card-backdrop");let d=!1,f=[],S=JSON.parse(localStorage.getItem("favourite"));S&&S.forEach(e=>{f[0]||(f[0]=e),f.push(e)});function p(e){return`${e.charAt(0).toUpperCase()}${e.slice(1)}`}function K(e,t=!1,s=!1){d=t,d||f.forEach(i=>{i._id===e._id&&(d=!0)}),z(e),l.classList.add("card-is-open"),document.body.classList.add("not-scrollable"),d===!0&&(document.querySelector(".add-favourite-btn").innerHTML=`Remove from
...
//# sourceMappingURL=exercises_card-DYF2-EXV.js.map
